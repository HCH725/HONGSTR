...
def main():
    ...
    parser.add_argument("--tfs", type=str, default="5m,15m,1h,4h", help="Target timeframes")
    ...
    if not src_file.exists():
        print(f"Source file not found: {src_file}. Please run ingest_historical.py first.")
        sys.exit(1)
