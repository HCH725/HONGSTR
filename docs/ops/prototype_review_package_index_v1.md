...
| see drift-to-canonical blocker-reference-target hint mapping | `docs/ops/prototype_blocker_reference_target_hint_alignment_record_v1.md` |
| see drift-to-canonical blocker-reference multiplicity hint mapping | `docs/ops/prototype_blocker_reference_multiplicity_hint_alignment_record_v1.md` |
| see drift-to-canonical blocker-reference ordering hint mapping | `docs/ops/prototype_blocker_reference_ordering_hint_alignment_record_v1.md` |
...
| see drift-to-canonical blocker-reference live-field cues | `docs/ops/prototype_blocker_reference_live_field_cue_alignment_record_v1.md` |
...
| see blocker-reference governance landing / closure | `docs/ops/prototype_blocker_reference_governance_landing_v1.md` |
| see drift-to-canonical blocker-reference contrast-sentence short-example block-intro phrases | `docs/ops/prototype_blocker_reference_short_example_block_intro_alignment_record_v1.md` |
