...
- blocker-reference multiplicity hint labels are not blocker-reference field-caption formatting; that formatting is governed by `docs/ops/prototype_blocker_reference_field_caption_casing_alignment_record_v1.md`
...
- blocker-reference multiplicity hint labels are not blocker-reference contrast-sentence combination rules; those rules are governed by `docs/ops/prototype_blocker_reference_contrast_sentence_combination_rule_alignment_record_v1.md`
...
- blocker-reference multiplicity hint labels are not blocker-reference placeholder shapes; those shapes are governed by `docs/ops/prototype_blocker_reference_placeholder_shape_alignment_record_v1.md`
