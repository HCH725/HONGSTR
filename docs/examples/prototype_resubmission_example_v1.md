...
Use compact inline forms only in explanatory prose; keep live blocker-evidence-reference entries rendered as stacked field blocks.
...
- keep the displayed field captions fixed as `Review note reference:`, `Closure evidence reference:`, `Fix evidence reference:`, and `Supporting evidence reference:`
- keep compact inline forms only in explanatory prose or compact table cells; keep live blocker-evidence-reference entries as stacked field blocks
