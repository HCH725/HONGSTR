...
| request-changes note | standardizes canonical `request_changes_reason` labels plus reviewer response-state and return-for-fixes feedback when the package is not ready | `docs/templates/prototype_review_request_changes_note_template_v1.md` |
