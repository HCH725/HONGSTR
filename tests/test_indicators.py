import pandas as pd
import pytest
from hongstr.signal.indicators import sma, ema, rsi, supertrend, vwap_session
...
def test_supertrend_logic():
    ...
    dir_s, band_s = supertrend(df['high'], df['low'], df['close'], period=5, multiplier=1.0)
...
def test_vwap():
    ...
    t = pd.Series(pd.to_datetime(["2024-01-01 10:00", "2024-01-01 11:00", "2024-01-01 12:00"]))
